...
//           <div className="w-48 h-48 mx-auto mb-8 bg-gradient-to-br from-blue-400 to-indigo-600 rounded-full flex items-center justify-center text-white text-6xl font-bold shadow-2xl">
//             GS
//           </div>
...
//             <button className="bg-blue-600 text-white px-8 py-3 rounded-full hover:bg-blue-700 transition-colors duration-200 flex items-center gap-2 shadow-lg">
//               <Download size={20} />
//               Download Resume
//             </button>
//             <button 
